(function () {
  ...
  const CACHE_KEY = 'shared-shopping-list-cache-v3';
...
startRealtime(onChange, onStatus) {
  ...
  ['shoppinglist_items', 'shoppinglist_rules', 'shoppinglist_stores', 'shoppinglist_note_items'].forEach((tableName) => {
  ...
  async function initStore() {
    ...
    try {
      ...
      const message = error.code === '42P01'
        ? 'Supabase setup issue: this build needs the latest SQL, including shoppinglist_note_items.'
